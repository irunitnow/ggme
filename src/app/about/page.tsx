...
export const metadata: Metadata = {
  title: 'About - AI SEO Blog Generator',
  description: 'Learn about our AI-powered blog generation platform and how it can transform your content creation process.',
}
