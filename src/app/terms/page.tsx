...
export const metadata: Metadata = {
  title: 'Terms of Use - AI SEO Blog Generator',
  description: 'Read our terms of use to understand the rules and guidelines for using our AI blog generation platform.',
}
