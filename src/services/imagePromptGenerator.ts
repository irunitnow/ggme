  ...
  try {
    ...
    try {
      ...
      if (!prompts.intro_image_alt_text) {
        prompts.intro_image_alt_text = `${recipeTitle} served on an elegant plate with garnishes, showing the finished dish from a 45-degree angle with professional lighting.`
      }
